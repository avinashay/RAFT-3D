...
def demo(args):
    ...
    fx, fy, cx, cy = (417.903625, 417.903625, 157.208288, 143.735811)
    limg1 = "/home/avinash/Desktop/datasets/endo/tracking/test15/color/0000000020.jpg"
    limg2 = "/home/avinash/Desktop/datasets/endo/tracking/test15/color/0000000010.jpg"
    ldisp1 = "/home/avinash/Desktop/datasets/endo/tracking/test15/depth/0000000020.png"
    ldisp2 = "/home/avinash/Desktop/datasets/endo/tracking/test15/depth/0000000010.png"
    img1 = cv2.imread(limg1)
    img2 = cv2.imread(limg2)
    disp1 = np.array(frame_utils.read_gen(ldisp1))
    disp2 = np.array(frame_utils.read_gen(ldisp2))
